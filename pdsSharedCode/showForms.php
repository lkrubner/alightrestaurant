...
function showForms($defaultForm=false) {
	...
	// 11-03-06 - I need to be able to set (using a hidden input in a form) the form that should appear 
	// after this current form has been submitted. 
	if (!isset($formName)) {
		if (array_key_exists("formName", $_POST)) {
			$formName = $_POST["formName"];
		}
	}
	if (!isset($formName)) $formName = $defaultForm; 
